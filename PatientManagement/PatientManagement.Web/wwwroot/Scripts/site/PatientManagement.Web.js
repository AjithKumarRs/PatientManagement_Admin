    ...
    (function (PatientManagement) {
        var UserListFormatter = (function () {
            ...
            UserListFormatter.prototype.format = function (ctx) {
                ...
                if (!idList || !idList.length)
                    return "";
                var byId = PatientManagement_44.Administration.UserRow.getLookup().itemById;
                var z;
    ...
    (function (PatientManagement) {
        var PatientsDialog = (function (_super) {
            ...
            function PatientsDialog() {
                ...
                PatientManagement_46.DialogUtils.pendingChangesConfirmation(_this.element, function () { return _this.getSaveState() != _this.loadedState; });
            ...
            NotesEditor.prototype.addClick = function () {
                ...
                dlg.okClick = function () {
                    ...
                    Q.insert(_this.items, 0, {
                        Text: text,
                        InsertUserDisplayName: PatientManagement_54.Authorization.userDefinition.DisplayName,
    ...
    (function (PatientManagement) {
        var NotificationsGrid = (function (_super) {
            ...
            NotificationsGrid.prototype.getButtons = function () {
                ...
                buttons.push(PatientManagement_57.Common.ExcelExportHelper.createToolButton({
                    grid: this,
                    hint: 'Export to Excel',
                    title: 'Export to Excel',
    ...
    (function (PatientManagement) {
        var PatientsGrid = (function (_super) {
            ...
            PatientsGrid.prototype.getButtons = function () {
                var _this = this;
                var buttons = _super.prototype.getButtons.call(this);
                buttons.push(PatientManagement_65.Common.ExcelExportHelper.createToolButton({
                    grid: this,
                    hint: 'Export to Excel',
                    title: 'Export to Excel',
