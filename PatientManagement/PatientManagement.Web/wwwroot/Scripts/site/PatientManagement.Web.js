...
(function (PatientManagement) {
    ...
    })(BasicSamples = PatientManagement.BasicSamples || (PatientManagement.BasicSamples = {}));
})(PatientManagement || (PatientManagement = {}));
var PatientManagement;
(function (PatientManagement) {
    var BasicSamples;
...
(function (PatientManagement) {
    ...
    (function (BasicSamples) {
        ...
        [['CustomerID', function () { return PatientManagement.Northwind.CustomerEditor; }], ['OrderDate', function () { return Serenity.DateEditor; }], ['CategoryID', function () { return Serenity.LookupEditor; }], ['DetailList', function () { return BasicSamples.FilteredLookupDetailEditor; }]].forEach(function (x) { return Object.defineProperty(FilteredLookupInDetailForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BasicSamples = PatientManagement.BasicSamples || (PatientManagement.BasicSamples = {}));
})(PatientManagement || (PatientManagement = {}));
var PatientManagement;
(function (PatientManagement) {
...
(function (PatientManagement) {
    ...
    (function (BasicSamples) {
        ...
        [['CustomerID', function () { return PatientManagement.Northwind.CustomerEditor; }], ['CustomerContactName', function () { return Serenity.StringEditor; }], ['CustomerContactTitle', function () { return Serenity.StringEditor; }], ['CustomerCity', function () { return Serenity.StringEditor; }], ['CustomerRegion', function () { return Serenity.StringEditor; }], ['CustomerCountry', function () { return Serenity.StringEditor; }], ['CustomerPhone', function () { return Serenity.StringEditor; }], ['CustomerFax', function () { return Serenity.StringEditor; }], ['OrderDate', function () { return Serenity.DateEditor; }], ['RequiredDate', function () { return Serenity.DateEditor; }], ['EmployeeID', function () { return Serenity.LookupEditor; }], ['DetailList', function () { return PatientManagement.Northwind.OrderDetailsEditor; }]].forEach(function (x) { return Object.defineProperty(PopulateLinkedDataForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BasicSamples = PatientManagement.BasicSamples || (PatientManagement.BasicSamples = {}));
})(PatientManagement || (PatientManagement = {}));
var PatientManagement;
(function (PatientManagement) {
...
(function (PatientManagement) {
    ...
    (function (BasicSamples) {
        ...
        [['StaticText', function () { return PatientManagement.StaticTextBlock; }], ['SomeInput', function () { return Serenity.StringEditor; }], ['HtmlList', function () { return PatientManagement.StaticTextBlock; }], ['FromLocalText', function () { return PatientManagement.StaticTextBlock; }], ['DisplayFieldValue', function () { return PatientManagement.StaticTextBlock; }]].forEach(function (x) { return Object.defineProperty(StaticTextBlockForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BasicSamples = PatientManagement.BasicSamples || (PatientManagement.BasicSamples = {}));
})(PatientManagement || (PatientManagement = {}));
var PatientManagement;
(function (PatientManagement) {
...
(function (PatientManagement) {
    ...
    })(Meeting = PatientManagement.Meeting || (PatientManagement.Meeting = {}));
})(PatientManagement || (PatientManagement = {}));
var PatientManagement;
(function (PatientManagement) {
    var Meeting;
...
(function (PatientManagement) {
    ...
    })(Northwind = PatientManagement.Northwind || (PatientManagement.Northwind = {}));
})(PatientManagement || (PatientManagement = {}));
var PatientManagement;
(function (PatientManagement) {
    var Northwind;
...
(function (PatientManagement) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnum(Gender, 'PatientManagement.Northwind.Entities.Gender');
    })(Northwind = PatientManagement.Northwind || (PatientManagement.Northwind = {}));
})(PatientManagement || (PatientManagement = {}));
var PatientManagement;
(function (PatientManagement) {
...
(function (PatientManagement) {
    ...
    })(Organization = PatientManagement.Organization || (PatientManagement.Organization = {}));
})(PatientManagement || (PatientManagement = {}));
var PatientManagement;
(function (PatientManagement) {
    var Organization;
...
(function (PatientManagement) {
    ...
    (function (BasicSamples) {
        ...
        }(PatientManagement.Northwind.ProductDialog));
    ...
    (function (Northwind) {
        var ProductGrid = (function (_super) {
            ...
            ProductGrid.prototype.getButtons = function () {
                ...
                buttons.push(PatientManagement.Common.PdfExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); },
...
(function (PatientManagement) {
    ...
    (function (BasicSamples) {
        ...
        }(PatientManagement.Northwind.ProductGrid));
...
(function (PatientManagement) {
    ...
    (function (BasicSamples) {
        var DefaultValuesInNewGrid = (function (_super) {
            ...
            DefaultValuesInNewGrid.prototype.addButtonClick = function () {
                this.editItem({
                    ...
                    EmployeeID: PatientManagement.Northwind.EmployeeRow.getLookup().items
                        .filter(function (x) { return x.FullName === 'Robert King'; })[0].EmployeeID,
                    ShipVia: PatientManagement.Northwind.ShipperRow.getLookup().items
            ...
            DefaultValuesInNewGrid.prototype.getButtons = function () {
                ...
                buttons.push({
                    ...
                    onClick: function () {
                        ...
                        var dlg = new PatientManagement.Northwind.OrderDialog();
                        ...
                        var chai = PatientManagement.Northwind.ProductRow.getLookup().items
                            .filter(function (x) { return x.ProductName === 'Chai'; })[0];
                        // LoadEntityAndOpenDialog, loads an OrderRow 
                        // to dialog and opens it
                        var lauraCallahanID = PatientManagement.Northwind.EmployeeRow.getLookup().items
        ...
        }(PatientManagement.Northwind.OrderGrid));
    ...
    (function (Northwind) {
        var OrderDialog = (function (_super) {
            ...
            OrderDialog.prototype.getToolbarButtons = function () {
                var _this = this;
                var buttons = _super.prototype.getToolbarButtons.call(this);
                buttons.push(PatientManagement.Common.ReportHelper.createToolButton({
                    title: 'Invoice',
...
(function (PatientManagement) {
    ...
    (function (BasicSamples) {
        ...
        }(PatientManagement.Northwind.OrderDialog));
...
(function (PatientManagement) {
    ...
    (function (BasicSamples) {
        var GetInsertedRecordIdDialog = (function (_super) {
            ...
            GetInsertedRecordIdDialog.prototype.onSaveSuccess = function (response) {
                ...
                if (this.isNew) {
                    ...
                    PatientManagement.Northwind.CategoryService.Retrieve({
        ...
        }(PatientManagement.Northwind.CategoryDialog));
...
(function (PatientManagement) {
    ...
    (function (BasicSamples) {
        ...
        }(PatientManagement.Northwind.CategoryGrid));
        ...
        var OtherFormInTabDialog = (function (_super) {
            ...
            function OtherFormInTabDialog() {
                ...
                _this.customerPropertyGrid = new Serenity.PropertyGrid(_this.byId("CustomerPropertyGrid"), {
                    items: Q.getForm(PatientManagement.Northwind.CustomerForm.formKey).filter(function (x) { return x.name != 'CustomerID'; }),
                    useCategories: true
                });
                // this is just a helper to access editors if needed
                _this.customerForm = new PatientManagement.Northwind.CustomerForm(_this.customerPropertyGrid.idPrefix);
                ...
                new Serenity.Toolbar(_this.byId("CustomerToolbar"), {
                    buttons: [{
                            ...
                            onClick: function () {
                                ...
                                PatientManagement.Northwind.CustomerService.Update({
                                    EntityId: id,
                                    Entity: c
                                }, function (response) {
                                    // reload customer list just in case
                                    Q.reloadLookup(PatientManagement.Northwind.CustomerRow.lookupKey);
                ...
                _this.form.CustomerID.change(function (e) {
                    ...
                    PatientManagement.Northwind.CustomerService.Retrieve({
                        EntityId: customerID
                    }, function (response) {
            ...
            OtherFormInTabDialog.prototype.getCustomerID = function () {
                ...
                return Q.first(PatientManagement.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
            };
        ...
        var PopulateLinkedDataDialog = (function (_super) {
            ...
            function PopulateLinkedDataDialog() {
                ...
                _this.form.CustomerID.changeSelect2(function (e) {
                    ...
                    var id = Q.first(PatientManagement.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
                    PatientManagement.Northwind.CustomerService.Retrieve({
                        EntityId: id
                    }, function (response) {
            ...
            PopulateLinkedDataDialog.prototype.getIdProperty = function () { return PatientManagement.Northwind.OrderRow.idProperty; };
            PopulateLinkedDataDialog.prototype.getLocalTextPrefix = function () { return PatientManagement.Northwind.OrderRow.localTextPrefix; };
            PopulateLinkedDataDialog.prototype.getNameProperty = function () { return PatientManagement.Northwind.OrderRow.nameProperty; };
            PopulateLinkedDataDialog.prototype.getService = function () { return PatientManagement.Northwind.OrderService.baseUrl; };
    ...
    (function (Northwind) {
        var SupplierDialog = (function (_super) {
            ...
            SupplierDialog.prototype.getLanguages = function () {
                return PatientManagement.LanguageList.getValue();
            };
...
(function (PatientManagement) {
    ...
    (function (BasicSamples) {
        ...
        }(PatientManagement.Northwind.SupplierDialog));
...
(function (PatientManagement) {
    ...
    (function (BasicSamples) {
        ...
        var ReadOnlyGrid = (function (_super) {
            ...
            return ReadOnlyGrid;
        }(PatientManagement.Northwind.SupplierGrid));
...
(function (PatientManagement) {
    ...
    (function (BasicSamples) {
        ...
        var ResponsiveDialog = (function (_super) {
            ...
            ResponsiveDialog.prototype.getFormKey = function () { return PatientManagement.Northwind.OrderForm.formKey; };
            ResponsiveDialog.prototype.getIdProperty = function () { return PatientManagement.Northwind.OrderRow.idProperty; };
            ResponsiveDialog.prototype.getLocalTextPrefix = function () { return PatientManagement.Northwind.OrderRow.localTextPrefix; };
            ResponsiveDialog.prototype.getNameProperty = function () { return PatientManagement.Northwind.OrderRow.nameProperty; };
            ResponsiveDialog.prototype.getService = function () { return PatientManagement.Northwind.OrderService.baseUrl; };
    ...
    (function (Northwind) {
        var CustomerDialog = (function (_super) {
            ...
            function CustomerDialog() {
                ...
                PatientManagement.DialogUtils.pendingChangesConfirmation(_this.element, function () { return _this.getSaveState() != _this.loadedState; });
                return _this;
            }
...
(function (PatientManagement) {
    ...
    (function (BasicSamples) {
        var SerialAutoNumberDialog = (function (_super) {
            ...
            SerialAutoNumberDialog.prototype.getNextNumber = function () {
                ...
                if (!val || val.length <= 1) {
                    ...
                    PatientManagement.Northwind.CustomerService.GetNextNumber({
                        Prefix: prefix,
        ...
        }(PatientManagement.Northwind.CustomerDialog));
...
(function (PatientManagement) {
    ...
    (function (BasicSamples) {
        ...
        }(PatientManagement.Northwind.CustomerGrid));
...
(function (PatientManagement) {
    ...
    (function (BasicSamples) {
        var ChangingLookupTextDialog = (function (_super) {
            ...
            function ChangingLookupTextDialog() {
                ...
                _this.form.ProductID.changeSelect2(function (e) {
                    ...
                    if (productID != null) {
                        _this.form.UnitPrice.value = PatientManagement.Northwind.ProductRow.getLookup().itemById[productID].UnitPrice;
                    }
                });
            ...
            ChangingLookupTextDialog.prototype.getLocalTextPrefix = function () { return PatientManagement.Northwind.OrderDetailRow.localTextPrefix; };
        ...
        }(PatientManagement.Common.GridEditorDialog));
    ...
    (function (BasicSamples) {
        ...
        var ChangingLookupTextEditor = (function (_super) {
            ...
            ChangingLookupTextEditor.prototype.getLookupKey = function () {
                return PatientManagement.Northwind.ProductRow.lookupKey;
            };
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupOrderDetailDialog = (function (_super) {
            ...
            function FilteredLookupOrderDetailDialog() {
                var _this = _super.call(this) || this;
                _this.form = new PatientManagement.Northwind.OrderDetailForm(_this.idPrefix);
                ...
                _this.form.ProductID.cascadeField = PatientManagement.Northwind.ProductRow.Fields.CategoryID;
                return _this;
        ...
        }(PatientManagement.Northwind.OrderDetailDialog));
...
(function (PatientManagement) {
    ...
    (function (Northwind) {
        ...
        }(PatientManagement.Common.GridEditorBase));
...
(function (PatientManagement) {
    ...
    (function (BasicSamples) {
        ...
        }(PatientManagement.Northwind.OrderDetailsEditor));
...
(function (PatientManagement) {
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupInDetailDialog = (function (_super) {
            ...
            FilteredLookupInDetailDialog.prototype.getIdProperty = function () { return PatientManagement.Northwind.OrderRow.idProperty; };
            FilteredLookupInDetailDialog.prototype.getLocalTextPrefix = function () { return PatientManagement.Northwind.OrderRow.localTextPrefix; };
            FilteredLookupInDetailDialog.prototype.getNameProperty = function () { return PatientManagement.Northwind.OrderRow.nameProperty; };
            FilteredLookupInDetailDialog.prototype.getService = function () { return PatientManagement.Northwind.OrderService.baseUrl; };
    ...
    (function (BasicSamples) {
        ...
        var ProduceSeafoodCategoryEditor = (function (_super) {
            ...
            ProduceSeafoodCategoryEditor.prototype.getLookupKey = function () {
                return PatientManagement.Northwind.CategoryRow.lookupKey;
            };
            /**
...
(function (PatientManagement) {
    ...
    PatientManagement.StaticTextBlock = StaticTextBlock;
})(PatientManagement || (PatientManagement = {}));
var PatientManagement;
(function (PatientManagement) {
    var BasicSamples;
...
(function (PatientManagement) {
    ...
    (function (BasicSamples) {
        var ConditionalFormattingGrid = (function (_super) {
            ...
            ConditionalFormattingGrid.prototype.getDialogType = function () { return PatientManagement.Northwind.ProductDialog; };
            ConditionalFormattingGrid.prototype.getIdProperty = function () { return PatientManagement.Northwind.ProductRow.idProperty; };
            ConditionalFormattingGrid.prototype.getLocalTextPrefix = function () { return PatientManagement.Northwind.ProductRow.localTextPrefix; };
            ConditionalFormattingGrid.prototype.getService = function () { return PatientManagement.Northwind.ProductService.baseUrl; };
            /**
            ...
            ConditionalFormattingGrid.prototype.getColumns = function () {
                var columns = _super.prototype.getColumns.call(this);
                var fld = PatientManagement.Northwind.ProductRow.Fields;
    ...
    (function (BasicSamples) {
        var CustomLinksInGrid = (function (_super) {
            ...
            CustomLinksInGrid.prototype.getColumns = function () {
                var columns = _super.prototype.getColumns.call(this);
                var fld = PatientManagement.Northwind.OrderRow.Fields;
            ...
            CustomLinksInGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass("customer-link")) {
                    ...
                    Q.confirm(message, function () {
                        ...
                        var customer = Q.first(PatientManagement.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == item.CustomerID; });
                        new PatientManagement.Northwind.CustomerDialog().loadByIdAndOpenDialog(customer.ID);
                    }, {
                        htmlEncode: false,
                        onNo: function () {
                            new PatientManagement.Northwind.OrderDialog().loadByIdAndOpenDialog(item.OrderID);
                        }
                    });
                }
                    ...
                    new PatientManagement.Northwind.OrderDialog().loadEntityAndOpenDialog({
                    ...
                    var countryFilter = this.findQuickFilter(Serenity.LookupEditor, PatientManagement.Northwind.OrderRow.Fields.ShipCountry);
...
(function (PatientManagement) {
    ...
    PatientManagement.SelectableEntityGrid = SelectableEntityGrid;
})(PatientManagement || (PatientManagement = {}));
...
(function (PatientManagement) {
    ...
    (function (BasicSamples) {
        var RowSelectionGrid = (function (_super) {
            ...
            RowSelectionGrid.prototype.getDialogType = function () { return PatientManagement.Northwind.SupplierDialog; };
            RowSelectionGrid.prototype.getIdProperty = function () { return PatientManagement.Northwind.SupplierRow.idProperty; };
            RowSelectionGrid.prototype.getLocalTextPrefix = function () { return PatientManagement.Northwind.SupplierRow.localTextPrefix; };
            RowSelectionGrid.prototype.getService = function () { return PatientManagement.Northwind.SupplierService.baseUrl; };
            return RowSelectionGrid;
        }(PatientManagement.SelectableEntityGrid));
        ...
        var InitialValuesForQuickFilters = (function (_super) {
            ...
            InitialValuesForQuickFilters.prototype.getQuickFilters = function () {
                ...
                Q.first(filters, function (x) { return x.field == fld.ShippingState; }).init = function (w) {
                    ...
                    w.value = PatientManagement.Northwind.OrderShippingState.NotShipped.toString();
                };
                return filters;
            };
            /**
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('delete-row')) {
                        Q.confirm('Delete record?', function () {
                            PatientManagement.Northwind.CustomerService.Delete({
                                EntityId: item.ID,
                            }, function (response) {
                                _this.refresh();
                            });
...
(function (PatientManagement) {
    ...
    (function (BasicSamples) {
        var InlineImageInGrid = (function (_super) {
            ...
            InlineImageInGrid.prototype.getDialogType = function () { return PatientManagement.Northwind.ProductDialog; };
            InlineImageInGrid.prototype.getIdProperty = function () { return PatientManagement.Northwind.ProductRow.idProperty; };
            InlineImageInGrid.prototype.getLocalTextPrefix = function () { return PatientManagement.Northwind.ProductRow.localTextPrefix; };
            InlineImageInGrid.prototype.getService = function () { return PatientManagement.Northwind.ProductService.baseUrl; };
...
(function (PatientManagement) {
    ...
    (function (BasicSamples) {
        var QuickFilterCustomization = (function (_super) {
            ...
            QuickFilterCustomization.prototype.getDialogType = function () { return PatientManagement.Northwind.OrderDialog; };
            QuickFilterCustomization.prototype.getIdProperty = function () { return PatientManagement.Northwind.OrderRow.idProperty; };
            QuickFilterCustomization.prototype.getLocalTextPrefix = function () { return PatientManagement.Northwind.OrderRow.localTextPrefix; };
            QuickFilterCustomization.prototype.getService = function () { return PatientManagement.Northwind.OrderService.baseUrl; };
            /**
             * This method is called to get list of quick filters to be created for this grid.
             * By default, it returns quick filter objects corresponding to properties that
             * have a [QuickFilter] attribute at server side OrderColumns.cs
        ...
        var TreeGrid = (function (_super) {
            ...
            function TreeGrid(container) {
                ...
                _this.treeMixin = new Serenity.TreeGridMixin({
                    ...
                    toggleField: PatientManagement.Northwind.OrderRow.Fields.CustomerCompanyName,
...
(function (PatientManagement) {
    ...
    (function (BasicSamples) {
        var ViewWithoutIDGrid = (function (_super) {
            ...
            ViewWithoutIDGrid.prototype.getNameProperty = function () { return PatientManagement.Northwind.SalesByCategoryRow.nameProperty; };
            ViewWithoutIDGrid.prototype.getLocalTextPrefix = function () { return PatientManagement.Northwind.SalesByCategoryRow.localTextPrefix; };
            ViewWithoutIDGrid.prototype.getService = function () { return PatientManagement.Northwind.SalesByCategoryService.baseUrl; };
            /**
             * This method is called to preprocess data returned from the list service
             */
        ...
        var MeetingAttendeeEditor = (function (_super) {
            ...
            MeetingAttendeeEditor.prototype.createToolbarExtensions = function () {
                ...
                Serenity.Widget.create({
                    type: Serenity.LookupEditor,
                    options: {
                        lookupKey: PatientManagement.Organization.ContactRow.lookupKey
                    },
                    ...
                    init: function (w) { return w.changeSelect2(function (x) {
                        if (Q.isEmptyOrNull(w.value))
                            return;
                        var contact = PatientManagement.Organization.ContactRow.getLookup().itemById[Q.toId(w.value)];
                        w.value = null;
                        if (!contact)
                            return;
            ...
            NotesEditor.prototype.addClick = function () {
                ...
                dlg.okClick = function () {
                    ...
                    Q.insert(_this.items, 0, {
                        Text: text,
                        InsertUserDisplayName: PatientManagement.Authorization.userDefinition.DisplayName,
...
(function (PatientManagement) {
    ...
    (function (BasicSamples) {
        ...
        }(PatientManagement.Common.BulkServiceAction));
