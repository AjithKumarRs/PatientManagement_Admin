...
(function (PatientManagement_2) {
    var PatientManagement;
    (function (PatientManagement) {
        var NewVisitTypeDialog = /** @class */ (function (_super) {
    ...
    (function (PatientManagement) {
        var VisitsGrid = /** @class */ (function (_super) {
            ...
            VisitsGrid.prototype.getButtons = function () {
                ...
                buttons.push(PatientManagement_6.Common.ExcelExportHelper.createToolButton({
                    grid: this,
                ...
                buttons.push(PatientManagement_6.Common.IcsExportHelper.createToolButton({
                    grid: this,
            ...
            VisitsGrid.prototype.getQuickFilters = function () {
                ...
                if (cookie) {
                    Q.first(filters, function (x) { return x.field == fields.CabinetId; }).init = function (w) {
                        w.value = cookie;
                        if (PatientManagement_6.Authorization.userDefinition.RestrictedToCabinets == 1)
    ...
    (function (PatientManagement) {
        var ActivityDialog = /** @class */ (function (_super) {
            ...
            function ActivityDialog() {
                ...
                PatientManagement_13.DialogUtils.pendingChangesConfirmation(_this.element, function () { return _this.getSaveState() != _this.loadedState; });
                return _this;
            }
    ...
    (function (PatientManagement) {
        var PatientHealthDialog = /** @class */ (function (_super) {
            ...
            function PatientHealthDialog() {
                ...
                PatientManagement_17.DialogUtils.pendingChangesConfirmation(_this.element, function () { return _this.getSaveState() != _this.loadedState; });
                return _this;
            }
    ...
    (function (PatientManagement) {
        var LifeStylesDialog = /** @class */ (function (_super) {
            ...
            function LifeStylesDialog() {
                ...
                PatientManagement_21.DialogUtils.pendingChangesConfirmation(_this.element, function () { return _this.getSaveState() != _this.loadedState; });
                return _this;
            }
    ...
    (function (PatientManagement) {
        var PatientsDialog = /** @class */ (function (_super) {
            ...
            function PatientsDialog() {
                ...
                PatientManagement_25.DialogUtils.pendingChangesConfirmation(_this.element, function () { return _this.getSaveState() != _this.loadedState; });
                return _this;
            }
    ...
    (function (PatientManagement) {
        var PatientsGrid = /** @class */ (function (_super) {
            ...
            PatientsGrid.prototype.getButtons = function () {
                var _this = this;
                var buttons = _super.prototype.getButtons.call(this);
                buttons.push(PatientManagement_27.Common.ExcelExportHelper.createToolButton({
                    grid: this,
                    hint: 'Export to Excel',
                    title: 'Export to Excel',
    ...
    (function (PatientManagement) {
        var NotificationsGrid = /** @class */ (function (_super) {
            ...
            NotificationsGrid.prototype.getButtons = function () {
                ...
                var buttons = _super.prototype.getButtons.call(this);
                buttons.splice(Q.indexOf(buttons, function (x) { return x.cssClass == "add-button"; }), 1);
                buttons.push(PatientManagement_33.Common.ExcelExportHelper.createToolButton({
                    grid: this,
                    hint: 'Export to Excel',
                    title: 'Export to Excel',
            ...
            NotesEditor.prototype.addClick = function () {
                ...
                dlg.okClick = function () {
                    ...
                    Q.insert(_this.items, 0, {
                        Text: text,
                        InsertUserDisplayName: PatientManagement_35.Authorization.userDefinition.DisplayName,
    ...
    (function (PatientManagement) {
        var HelloModal = /** @class */ (function (_super) {
            ...
            function HelloModal(elem, opt) {
                var _this = _super.call(this, elem, opt) || this;
                _this.formCabinet = new PatientManagement_40.Common.HelloModalAddCabinetPanel(_this.byId("ModalBodyCabinet"));
                _this.formPatient = new PatientManagement_40.Common.HelloModalAddPatientPanel(_this.byId("ModalBodyPatient"));
                _this.formVisitType = new PatientManagement_40.Common.HelloModalAddVisitTypePanel(_this.byId("ModalBodyVisitType"));
                _this.formVisit = new PatientManagement_40.Common.HelloModalAddVisitPanel(_this.byId("ModalBodyVisit"));
    ...
    (function (PatientManagement) {
        var UserListFormatter = /** @class */ (function () {
            ...
            UserListFormatter.prototype.format = function (ctx) {
                ...
                if (!idList || !idList.length)
                    return "";
                var byId = PatientManagement_49.Administration.UserRow.getLookup().itemById;
                var z;
    ...
    (function (PatientManagement) {
        var RoleListFormatter = /** @class */ (function () {
            ...
            RoleListFormatter.prototype.format = function (ctx) {
                ...
                if (!idList || !idList.length)
                    return "";
                var byId = PatientManagement_53.Administration.RoleRow.getLookup().itemById;
                var z;
...
(function (PatientManagement_84) {
    ...
    (function (PatientManagement) {
        ...
        [['PatientId', function () { return Serenity.IntegerEditor; }], ['Name', function () { return Serenity.StringEditor; }], ['Gender', function () { return Serenity.EnumEditor; }], ['PersonalNumber', function () { return Serenity.StringEditor; }], ['PhoneNumber', function () { return Serenity.StringEditor; }], ['Email', function () { return Serenity.EmailEditor; }], ['FirstRegistrationDate', function () { return Serenity.DateTimeEditor; }], ['Address', function () { return Serenity.StringEditor; }], ['Height', function () { return Serenity.IntegerEditor; }], ['Weight', function () { return Serenity.IntegerEditor; }], ['NotifyOnChange', function () { return PatientManagement_84.BsSwitchEditor; }], ['NoteList', function () { return PatientManagement.NotesEditor; }], ['TenantId', function () { return Serenity.LookupEditor; }]].forEach(function (x) { return Object.defineProperty(PatientsForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
