...
(function (PatientManagement_6) {
    var PatientManagement;
    (function (PatientManagement) {
        var CabinetRepresentativesService;
        (function (CabinetRepresentativesService) {
            CabinetRepresentativesService.baseUrl = 'PatientManagement/CabinetRepresentatives';
            [
                'Create',
                'Update',
                'Delete',
                ...
                CabinetRepresentativesService[x] = function (r, s, o) {
                    return Q.serviceRequest(CabinetRepresentativesService.baseUrl + '/' + x, r, s, o);
                };
            });
        })(CabinetRepresentativesService = PatientManagement.CabinetRepresentativesService || (PatientManagement.CabinetRepresentativesService = {}));
        ...
        var CabinetsForm = /** @class */ (function (_super) {
            ...
            function CabinetsForm(prefix) {
                ...
                if (!CabinetsForm.init) {
                    ...
                    var w3 = s.HtmlContentEditor;
                    var w4 = s.IntegerEditor;
                    var w5 = PatientManagement_8.AddressAutocomplete;
        ...
        var PatientsForm = /** @class */ (function (_super) {
            ...
            function PatientsForm(prefix) {
                ...
                if (!PatientsForm.init) {
                    ...
                    var w4 = PatientManagement_31.AddressAutocompleteNoMap;
                    var w5 = s.ImageUploadEditor;
                    var w6 = s.DateTimeEditor;
                    var w7 = PatientManagement_31.BsSwitchEditor;
...
(function (PatientManagement_36) {
    ...
    (function (PatientManagement) {
        ...
        (function (RepeatPeriod) {
            RepeatPeriod[RepeatPeriod["Day"] = 1] = "Day";
            RepeatPeriod[RepeatPeriod["Week"] = 2] = "Week";
            RepeatPeriod[RepeatPeriod["Month"] = 3] = "Month";
            RepeatPeriod[RepeatPeriod["Year"] = 4] = "Year";
        })(RepeatPeriod = PatientManagement.RepeatPeriod || (PatientManagement.RepeatPeriod = {}));
        ...
        var VisitsForm = /** @class */ (function (_super) {
            ...
            function VisitsForm(prefix) {
                ...
                if (!VisitsForm.init) {
                    ...
                    var s = Serenity;
                    var w0 = s.LookupEditor;
                    var w1 = PatientManagement_46.BsSwitchEditor;
        ...
        var RoleListFormatter = /** @class */ (function () {
            ...
            RoleListFormatter.prototype.format = function (ctx) {
                ...
                if (!idList || !idList.length)
                    return "";
                var byId = PatientManagement_51.Administration.RoleRow.getLookup().itemById;
                var z;
...
(function (PatientManagement) {
    ...
    (function (ScriptInitialization) {
        ...
        Serenity.DataGrid.defaultPersistanceStorage = new PatientManagement.Common.UserPreferenceStorage();
    ...
    (function (PatientManagement) {
        var VisitsGrid = /** @class */ (function (_super) {
            ...
            VisitsGrid.prototype.getButtons = function () {
                ...
                buttons.push(PatientManagement_55.Common.ExcelExportHelper.createToolButton({
                    grid: this,
                    hint: 'Export to Excel',
                    title: 'Export to Excel',
                ...
                buttons.push(PatientManagement_55.Common.IcsExportHelper.createToolButton({
                    grid: this,
...
(function (PatientManagement) {
    ...
    (function (Membership) {
        ...
        var AddedVisitsFromUserPanel = /** @class */ (function (_super) {
            ...
            AddedVisitsFromUserPanel.prototype.onViewSubmit = function () {
                if (!_super.prototype.onViewSubmit.call(this)) {
                    return false;
                }
                var request = this.view.params;
                request.Criteria = Serenity.Criteria.and(request.Criteria, [['InsertUserId'], '=', PatientManagement.Authorization.userDefinition.UserId]);
                return true;
            };
    ...
    (function (PatientManagement) {
        var UserListFormatter = /** @class */ (function () {
            ...
            UserListFormatter.prototype.format = function (ctx) {
                ...
                if (!idList || !idList.length)
                    return "";
                var byId = PatientManagement_63.Administration.UserRow.getLookup().itemById;
                var z;
        ...
        var CalendarCabinetsEditor = /** @class */ (function (_super) {
            ...
            function CalendarCabinetsEditor(container) {
                ...
                _this.changeSelect2(function (e) {
                    ...
                    $("#calendar").fullCalendar('refetchEvents');
                    PatientManagement.CalendarVisitsDialog.refreshVisitForTodayBox();
                });
                return _this;
            }
    ...
    (function (PatientManagement) {
        var PatientsDialog = /** @class */ (function (_super) {
            ...
            function PatientsDialog() {
                ...
                PatientManagement_66.DialogUtils.pendingChangesConfirmation(_this.element, function () { return _this.getSaveState() != _this.loadedState; });
                return _this;
            }
        ...
        var VisitsDialog = /** @class */ (function (_super) {
            ...
            function VisitsDialog() {
                ...
                _this.form.PatientId.changeSelect2(function (e) {
                    ...
                    if (!patientId)
                        return;
                    _this.checkAutomaticEmailAlert(patientId);
                });
                ...
                _this.form.RepeatPeriod.changeSelect2(function (e) {
                    _this.showRepeatUntilBox();
                });
                _this.form.RepeatTimes.change(function (e) {
                    _this.showRepeatUntilBox();
                });
                return _this;
            }
            ...
            VisitsDialog.prototype.checkAutomaticEmailAlert = function (patientId) {
                var _this = this;
            ...
            VisitsDialog.prototype.showRepeatUntilBox = function () {
        ...
        var CalendarVisitsDialog = /** @class */ (function (_super) {
            ...
            function CalendarVisitsDialog() {
                ...
                _this.newPredifinedVisit = function (start, end) {
                    ...
                    p.StartDate = start;
                    p.EndDate = end;
                    _this.loadEntityAndOpenDialog({
                        StartDate: start,
                        EndDate: end,
                        CabinetId: $.cookie("CabinetPreference")
                    });
                };
                _this.updateVisit = function (visitId, start, end, isRepeated, repeatCounter) {
                    PatientManagement.VisitsService.Retrieve({
                        ...
                        PatientManagement.VisitsService.Update({
                            ...
                            if (p.IsRepeated ||
                                ...
                                CalendarVisitsDialog_1.refreshVisitForTodayBox();
                            }
                        });
                    });
                };
            ...
            CalendarVisitsDialog_1 = CalendarVisitsDialog;
            CalendarVisitsDialog.prototype.onSaveSuccess = function (response) {
                CalendarVisitsDialog_1.refreshVisitForTodayBox();
                $("#calendar").fullCalendar('refetchEvents');
            };
            CalendarVisitsDialog.refreshVisitForTodayBox = function () {
            ...
            CalendarVisitsDialog = CalendarVisitsDialog_1 = __decorate([
                Serenity.Decorators.registerClass()
            ], CalendarVisitsDialog);
            return CalendarVisitsDialog;
            var CalendarVisitsDialog_1;
    ...
    (function (PatientManagement) {
        var HelloModal = /** @class */ (function (_super) {
            ...
            function HelloModal(elem, opt) {
                ...
                _this.formCabinet = new PatientManagement_71.Common.HelloModalAddCabinetPanel(_this.byId("ModalBodyCabinet"));
                _this.formPatient = new PatientManagement_71.Common.HelloModalAddPatientPanel(_this.byId("ModalBodyPatient"));
                _this.formVisitType = new PatientManagement_71.Common.HelloModalAddVisitTypePanel(_this.byId("ModalBodyVisitType"));
                _this.formVisit = new PatientManagement_71.Common.HelloModalAddVisitPanel(_this.byId("ModalBodyVisit"));
    ...
    (function (PatientManagement) {
        var LifeStylesDialog = /** @class */ (function (_super) {
            ...
            function LifeStylesDialog() {
                ...
                PatientManagement_72.DialogUtils.pendingChangesConfirmation(_this.element, function () { return _this.getSaveState() != _this.loadedState; });
                return _this;
            }
            ...
            NotesEditor.prototype.addClick = function () {
                ...
                dlg.okClick = function () {
                    ...
                    Q.insert(_this.items, 0, {
                        Text: text,
                        InsertUserDisplayName: PatientManagement_79.Authorization.userDefinition.DisplayName,
    ...
    (function (PatientManagement) {
        var PatientHealthDialog = /** @class */ (function (_super) {
            ...
            function PatientHealthDialog() {
                ...
                PatientManagement_84.DialogUtils.pendingChangesConfirmation(_this.element, function () { return _this.getSaveState() != _this.loadedState; });
                return _this;
            }
    ...
    (function (PatientManagement) {
        var PatientsGrid = /** @class */ (function (_super) {
            ...
            PatientsGrid.prototype.getButtons = function () {
                var _this = this;
                var buttons = _super.prototype.getButtons.call(this);
                buttons.push(PatientManagement_99.Common.ExcelExportHelper.createToolButton({
                    grid: this,
                    hint: 'Export to Excel',
                    title: 'Export to Excel',
...
var PatientManagement;
(function (PatientManagement_109) {
    var PatientManagement;
    (function (PatientManagement) {
    ...
    })(PatientManagement = PatientManagement_109.PatientManagement || (PatientManagement_109.PatientManagement = {}));
})(PatientManagement || (PatientManagement = {}));
var PatientManagement;
(function (PatientManagement_110) {
    var PatientManagement;
    (function (PatientManagement) {
    ...
    })(PatientManagement = PatientManagement_110.PatientManagement || (PatientManagement_110.PatientManagement = {}));
})(PatientManagement || (PatientManagement = {}));
