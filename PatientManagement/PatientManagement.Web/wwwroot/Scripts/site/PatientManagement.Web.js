...
(function (PatientManagement_10) {
    ...
    (function (PatientManagement) {
        ...
        (function (NotificationsRow) {
            ...
            ['NotificationId', 'EntityType', 'EntityId', 'Text', 'InsertUserId', 'InsertDate'].forEach(function (x) { return Fields[x] = x; });
    ...
    (function (PatientManagement) {
        var PatientsDialog = (function (_super) {
            ...
            function PatientsDialog() {
                ...
                PatientManagement_28.DialogUtils.pendingChangesConfirmation(_this.element, function () { return _this.getSaveState() != _this.loadedState; });
            ...
            NotesEditor.prototype.addClick = function () {
                ...
                dlg.okClick = function () {
                    ...
                    Q.insert(_this.items, 0, {
                        Text: text,
                        InsertUserDisplayName: PatientManagement_37.Authorization.userDefinition.DisplayName,
