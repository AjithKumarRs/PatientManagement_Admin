...
(function (PatientManagement_3) {
    ...
    (function (PatientManagement) {
        ...
        (function (ActivityRow) {
            ...
            ['PatientId', 'MovementAndTraining', 'Profession', 'InsertUserId', 'InsertDate', 'UpdateUserId', 'UpdateDateField', 'IsActive', 'TenantId', 'TenantName', 'InsertUserName', 'UpdateUserName'].forEach(function (x) { return Fields[x] = x; });
