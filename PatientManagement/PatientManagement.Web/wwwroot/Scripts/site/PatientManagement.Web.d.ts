...
declare namespace PatientManagement.PatientManagement {
    ...
    namespace ActivityRow {
        ...
        const lookupKey = "PatientManagement.Activity";
...
declare namespace PatientManagement.PatientManagement {
    namespace CabinetRepresentativesService {
        const baseUrl = "PatientManagement/CabinetRepresentatives";
        function Create(request: Serenity.SaveRequest<CabinetRepresentativesRow>, onSuccess?: (response: Serenity.SaveResponse) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        function Update(request: Serenity.SaveRequest<CabinetRepresentativesRow>, onSuccess?: (response: Serenity.SaveResponse) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        function Delete(request: Serenity.DeleteRequest, onSuccess?: (response: Serenity.DeleteResponse) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        function Retrieve(request: Serenity.RetrieveRequest, onSuccess?: (response: Serenity.RetrieveResponse<CabinetRepresentativesRow>) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        function List(request: Serenity.ListRequest, onSuccess?: (response: Serenity.ListResponse<CabinetRepresentativesRow>) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        const enum Methods {
...
declare namespace PatientManagement.PatientManagement {
    interface ListCriteriaStartDateEndDateRequest extends Serenity.ListRequest {
        StartDate?: string;
        EndDate?: string;
        CabinetId?: number;
    }
...
declare namespace PatientManagement.PatientManagement {
    namespace VisitTypesService {
        ...
        function ListForMenu(request: Serenity.ListRequest, onSuccess?: (response: Serenity.ListResponse<VisitTypesRow>) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        const enum Methods {
...
declare namespace PatientManagement.PatientManagement {
    namespace VisitsService {
        ...
        const enum Methods {
            ...
            Undelete = "PatientManagement/Visits/Undelete",
...
declare namespace PatientManagement {
    class AddressAutocompleteNoMap extends Serenity.Widget<IAddressAutocompleteNoMapOptions> implements Serenity.ISetEditValue {
        constructor(element: JQuery, opt: IAddressAutocompleteNoMapOptions);
        setEditValue(source: any, property: Serenity.PropertyItem): void;
    }
    interface IAddressAutocompleteNoMapOptions {
        option: string;
    }
}
declare namespace PatientManagement {
...
declare namespace PatientManagement.PatientManagement {
    class VisitsDialog extends Serenity.EntityDialog<VisitsRow, any> {
        ...
        protected updateInterface(): void;
        constructor();
        checkAutomaticEmailAlert(patientId: any): void;
...
declare namespace PatientManagement.PatientManagement {
    class CalendarVisitsDialog extends VisitsDialog {
        ...
        protected onSaveSuccess(response: Serenity.SaveResponse): void;
        static refreshVisitForTodayBox(): void;
