...
namespace PatientManagement.Administration {
    export namespace SentEmailsService {
        ...
        export declare function Create(request: Serenity.SaveRequest<SentEmailsRow>, onSuccess?: (response: Serenity.SaveResponse) => void, opt?: Serenity.ServiceOptions<any>): JQueryXHR;
        ...
        ['Create', 'Update', 'Delete', 'Retrieve', 'List'].forEach(x => {
            (<any>SentEmailsService)[x] = function (r, s, o) { return Q.serviceRequest(baseUrl + '/' + x, r, s, o); };
