...
using PatientManagement.Reservation.Models.TokenAuth;
using PatientManagement.Reservation.MultiTenancy;

namespace PatientManagement.Reservation.Controllers
{
    [Route("api/[controller]/[action]")]
    public class TokenAuthController : ReservationControllerBase
    {
