...
namespace PatientManagement.Reservation
{
    ...
    public class ReservationWebCoreModule : AbpModule
    {
        ...
        public ReservationWebCoreModule(IHostingEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                 .CreateControllersForAppServices(
                     typeof(ReservationApplicationModule).GetAssembly()
                 );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(ReservationWebCoreModule).GetAssembly());
        }
    }
}
